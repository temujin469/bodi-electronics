(function ($) {
  ...
  if (
    $.isFunction($.fn["themePluginAnimatedLetters"]) &&
    ($("[data-plugin-animated-letters]").length ||
  ...
  if (
    ...
    $("[data-plugin-carousel]:not(.manual), .owl-carousel:not(.manual)").length
  ) {
    theme.fn.intObsInit(
  ...
  if (
    $.isFunction($.fn["themePluginTweets"]) &&
    $("[data-plugin-tweets]").length
  ) {
    $(function () {
  ...
  if (
    ...
    ($("#searchForm").length || $(".header-nav-features-search-reveal").length)
  ) {

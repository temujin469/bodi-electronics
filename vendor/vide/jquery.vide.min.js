!(function (e, t) {
  ...
  function s(e) {
    for (
      ...
      (t = o.indexOf(":")),
        ...
        "string" ==
          typeof (n =
            "string" == typeof (n = (n = o.substring(t + 1)) || void 0)
              ? "true" === n || ("false" !== n && n)
              : n) && (n = isNaN(n) ? n : +n),
        (s[i] = n);
  ...
  (i.prototype.init = function () {
    ...
    (d.match(/iPad/i) || d.match(/iPhone/i)) &&
      c.autoplay &&
      1 == c.muted &&
      (e.css({ visibility: "visible", opacity: 1 }),
      t.css("background-image", "none")),
      p.on("resize." + f, function () {
        c.resizing && n.resize();
      }),
      t.append(e);
  }),
    ...
    (i.prototype.resize = function () {
      ...
      this.$video &&
        ...
        (o = i.videoWidth),
        (i = n.height()) / t < (n = n.width()) / o
          ? e.css({ width: n + 2, height: "auto" })
          : e.css({ width: "auto", height: i + 2 }));
    }),
    (i.prototype.destroy = function () {
      delete g[f].lookup[this.index],
    ...
    (g.fn[f] = function (e, t) {
      ...
      return (
        this.each(function () {
          (o = g.data(this, f)) && o.destroy(),
            ((o = new i(this, e, t)).index = g[f].lookup.push(o) - 1),
            g.data(this, f, o);
        }),
        this
      );
